...
function FeaturedProducts() {
  return (
    <div  id='anchor-featured' data-aos='flip-down' data-aos-offset='-200' data-aos-duration='1300' data-aos-once='true'  style={{maxWidth:'100%',height:'100vh',backgroundColor:'rgb(242,242,242)'}}>
